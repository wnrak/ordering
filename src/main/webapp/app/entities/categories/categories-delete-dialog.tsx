...
export const CategoriesDeleteDialog = (props: ICategoriesDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="yoplaApp.categories.delete.question">
        <Translate contentKey="yoplaApp.categories.delete.question" interpolate={{ id: categoriesEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-categories" color="danger" onClick={confirmDelete}>
