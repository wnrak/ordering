  ...
  return (
    <div>
      <h2 id="orders-heading">
        <Translate contentKey="yoplaApp.orders.home.title">Orders</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="yoplaApp.orders.home.createLabel">Create new Orders</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('yoplaApp.orders.home.search')}
                />
        ...
        {ordersList && ordersList.length > 0 ? (
            ...
            <tbody>
              {ordersList.map((orders, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{orders.user ? orders.user.login : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="yoplaApp.orders.home.notFound">No Orders found</Translate>
            </div>
          )
        )}
      </div>
